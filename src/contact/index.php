...
<main>
	<section class="section_hero_ft container pb-5">
		<div class="px-4 py-5 my-5 text-center">
			<h1 class="display-5 fw-bold text-body-emphasis mb-3">Contact us</h1>
			<p class="lead mb-4">We would love to hear from you.</p>
		</div>
	</section>
	<section class="py-3 py-md-5 py-xl-10 mb-5">
					...
					<div class="border overflow-hidden">
						<form action="#!">
							<div class="row gy-4 gy-xl-5 p-4 p-xl-5">
								...
								<div class="col-12">
									<div class="d-grid">
										<button class="btn default_btn btn-lg px-4" type="submit" >Send Message</button>
									</div>
								</div>
							</div>
						</form>
					...
					<div class="row justify-content-xl-center">
						<div class="col-12 col-xl-11">
							<div class="mb-4 mb-md-5">
								...
								<div>
									<h4 class="mb-2">Amsterdam Office</h4>
									<p class="mb-2">Please visit us to have a discussion.</p>
									<hr class="w-50 mb-3 border-dark-subtle">
									<address class="m-0 text-secondary">NMS PRODUCTIONS EUROPE B.V.Herengracht 257, 1016 BJ, Amsterdam, The Netherlands</address>
								</div>
							</div>
								...
								<div class="col-12 col-sm-6">
									<div class="mb-4 mb-sm-0">
										...
										<div>
											...
											<p class="mb-0">
												<a class="link-secondary text-decoration-none" href="tel:+6394571">(63) 945-7165518</a>
											</p>
										</div>
									</div>
								</div>
								<div class="col-12 col-sm-6">
									<div class="mb-4 mb-sm-0">
										...
										<div>
											...
											<hr class="w-75 mb-3 border-dark-subtle">
											<p class="mb-0">
												<a class="link-secondary text-decoration-none" href="mailto:example@sportstxt.com">example@sportstxt.com</a>
											</p>
										</div>
									</div>
								</div>
