...
<main >
		...
		<section class="section section_mission container mx-auto ">
			<div class=" col-xxl-8 px-4 py-md-5 py-3">
				<div class="row flex-lg-row-reverse align-items-center g-5 py-md-5">
					<div class="col-10 col-sm-8 col-lg-6">
						<img src="./assets/img/mission.avif" class="d-block mx-lg-auto img-fluid" alt="coach teaching" width="700" height="500" loading="lazy">
					</div>
					<div class="col-lg-6">
			...
			<div class="container mx-auto px-4 py-5">
				...
				<div class="row row-cols-1 row-cols-sm-2 g-5 py-5">
					<div class="col d-flex flex-column gap-2">
						<svg class="opacity-75" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
